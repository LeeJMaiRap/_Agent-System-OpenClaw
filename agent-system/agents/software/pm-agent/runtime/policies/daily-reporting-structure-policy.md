...
Dùng khi report cho chính hệ `agent-system/agents/software/pm-agent/`.
...
### Framework
- `agent-system/agents/software/pm-agent/reports/daily/`
...
Ưu tiên đọc:
1. `agent-system/agents/software/pm-agent/STATUS.md`
2. `agent-system/agents/software/pm-agent/runtime/`
3. `agent-system/agents/software/pm-agent/eval/`
4. `agent-system/agents/software/pm-agent/skills/`
...
- nếu project active nhưng không có meaningful update quá lâu, phải xem xét stale detection theo `agent-system/agents/software/pm-agent/runtime/policies/stale-project-detection-policy.md`

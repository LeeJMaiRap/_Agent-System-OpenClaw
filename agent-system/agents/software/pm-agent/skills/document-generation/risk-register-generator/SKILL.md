...
Output phải bám theo `agent-system/agents/software/pm-agent/templates/risk-register-template.md`.
...
- Tham khảo: `agent-system/agents/software/pm-agent/templates/risk-register-template.md`

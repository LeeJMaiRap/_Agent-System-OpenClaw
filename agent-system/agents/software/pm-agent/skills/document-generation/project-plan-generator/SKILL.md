...
Output phải bám sát template trong `agent-system/agents/software/pm-agent/templates/plan-template.md`, và có thể bổ sung phần `Risk Mitigation` / `Success Criteria` khi đầu vào đủ dữ liệu.
...
- Tham khảo: `agent-system/agents/software/pm-agent/templates/plan-template.md`

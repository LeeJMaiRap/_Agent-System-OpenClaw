...
Output phải tuân thủ template có sẵn trong `agent-system/agents/software/pm-agent/templates/requirements-template.md`.
...
- Tham khảo: `agent-system/agents/software/pm-agent/templates/requirements-template.md`

...
Output phải bám theo `agent-system/agents/software/pm-agent/templates/wbs-template.md`.
...
- Tham khảo: `agent-system/agents/software/pm-agent/templates/wbs-template.md`

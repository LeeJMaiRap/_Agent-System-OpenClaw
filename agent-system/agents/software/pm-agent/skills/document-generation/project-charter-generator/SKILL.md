...
Output phải tuân thủ template có sẵn trong `agent-system/agents/software/pm-agent/templates/charter-template.md`.
...
- Tham khảo: `agent-system/agents/software/pm-agent/templates/charter-template.md`

...
Output phải bám theo `agent-system/agents/software/pm-agent/templates/rules-template.md`, và được phép mở rộng khi dự án cần rule cụ thể hơn.
...
- Tham khảo: `agent-system/agents/software/pm-agent/templates/rules-template.md`

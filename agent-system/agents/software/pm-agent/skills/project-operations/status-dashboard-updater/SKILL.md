...
Output phải bám theo `agent-system/agents/software/pm-agent/templates/status-dashboard-template.md`.
...
- Tham khảo: `agent-system/agents/software/pm-agent/templates/status-dashboard-template.md`

...
Output phải bám theo `agent-system/agents/software/pm-agent/templates/task-board-template.md`.
...
- Tham khảo: `agent-system/agents/software/pm-agent/templates/task-board-template.md`

...
description: Tạo file báo cáo hằng ngày cho một project hoặc cho chính PM Agent framework vào cuối ngày hoặc theo lịch định kỳ; dùng khi cần snapshot thay đổi trong ngày, ai đã làm gì (human / agent / subagent), tiến độ, issue/risk chính và next actions. Output mặc định vào `projects/active/[project-name]/reports/daily/YYYY-MM-DD.md` hoặc `agent-system/agents/software/pm-agent/reports/daily/YYYY-MM-DD.md` tùy mode.
---
...
Dùng cho chính `agent-system/agents/software/pm-agent/`.

Đọc tối thiểu các nguồn sau nếu có:
- `agent-system/agents/software/pm-agent/STATUS.md`
- `agent-system/agents/software/pm-agent/runtime/`
- `agent-system/agents/software/pm-agent/eval/`
- `agent-system/agents/software/pm-agent/skills/`
...
`agent-system/agents/software/pm-agent/runtime/policies/daily-reporting-structure-policy.md`
...
- `agent-system/agents/software/pm-agent/runtime/policies/daily-reporting-structure-policy.md` - policy cấu trúc daily reporting

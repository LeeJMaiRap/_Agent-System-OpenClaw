...
Output phải bám theo `agent-system/agents/software/pm-agent/templates/issue-log-template.md`.
...
- Tham khảo: `agent-system/agents/software/pm-agent/templates/issue-log-template.md`

...
Output phải bám theo `agent-system/agents/software/pm-agent/templates/change-log-template.md`.
...
- Tham khảo: `agent-system/agents/software/pm-agent/templates/change-log-template.md`

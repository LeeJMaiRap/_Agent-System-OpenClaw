...
Output phải bám theo `agent-system/agents/software/pm-agent/templates/lessons-learned-template.md`.
...
- Tham khảo: `agent-system/agents/software/pm-agent/templates/lessons-learned-template.md`

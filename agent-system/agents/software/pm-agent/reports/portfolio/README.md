...
**Output location:**
- `agent-system/agents/software/pm-agent/reports/portfolio/active-projects-dashboard.md`
...
**Output location:**
- `agent-system/agents/software/pm-agent/reports/portfolio/on-hold-projects-dashboard.md`
...
**Output location:**
- `agent-system/agents/software/pm-agent/reports/portfolio/stopped-projects-dashboard.md`
...
**Output location:**
- `agent-system/agents/software/pm-agent/reports/portfolio/archived-projects-dashboard.md`
...
**Output location:**
`agent-system/agents/software/pm-agent/reports/portfolio/portfolio-summary.md`

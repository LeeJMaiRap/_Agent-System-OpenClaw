...
`agent-system/` is the agent-system home. It must preserve PM Agent workflow, policies, verification levels, and approvals.
...
- source-of-truth conflict appears with active PM Agent;
